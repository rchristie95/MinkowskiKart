...
//  Copyright (C) 2006-2015 MinkowskiKart-Team, Joerg Henrichs, Steve Baker
//
...
protected:
    ...
    /** Preferred-frame relativistic diagnostics for this kart. */
    Relativity::RelativisticState m_relativistic_state;
...
public:
    ...
    virtual void syncPostPhysicsState(int ticks) OVERRIDE;
    ...
    // ----------------------------------------------------------------------------------------
    const Relativity::RelativisticState& getRelativisticState() const
    {
        return m_relativistic_state;
    }
    // ----------------------------------------------------------------------------------------
