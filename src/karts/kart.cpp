...
//  Copyright (C) 2006-2016 MinkowskiKart-Team, Joerg Henrichs, Steve Baker
//
...
void Kart::applyEngineForce(float force)
{
    ...
    force = Relativity::KartAdapter::scalePropulsiveForce(force, m_speed);
